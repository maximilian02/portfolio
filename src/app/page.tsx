const HomePage = () => {
  return (
    <>
      <h1 className="text-xl font-bold mb-2">Hey there! I'm Maximiliano Zelarayán, but now that you're here you can call me Max.</h1>

      <p>As an experienced software engineer with over a decade of experience, I have a proven track record of designing, developing, and delivering high-quality software solutions for complex business problems. With expertise in multiple programming languages and technologies, I have successfully led cross-functional teams and collaborated with stakeholders to deliver innovative solutions that meet business needs.</p>
      <br />
